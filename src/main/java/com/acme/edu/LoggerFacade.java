...
public class LoggerFacade {
    ...
    public static void log(int message) throws IllegalMessageException {
        loggerController.logMessage(new IntegerMessage(message));
    }

    public static void log(byte message) throws IllegalMessageException {
        loggerController.logMessage(new ByteMessage(message));
    }

    public static void log(String message) throws IllegalMessageException {
        loggerController.logMessage(new StringMessage(message));
    }

    public static void log(char message) throws IllegalMessageException {
        loggerController.logMessage(new CharMessage(message));
    }

    public static void log(boolean message) throws IllegalMessageException {
        loggerController.logMessage(new BooleanMessage(message));
    }

    public static void log(Object message) throws IllegalMessageException {
    ...
    public static void stopLogging() throws IllegalMessageException {
